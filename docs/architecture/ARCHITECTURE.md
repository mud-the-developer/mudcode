...
| **BridgeHookServer** | `src/bridge/runtime/hook-server.ts` | HTTP server, receives agent plugin events (hook mode) |
| **BridgeMessageRouter** | `src/bridge/runtime/message-router.ts` | Routes Discord messages to correct tmux window |
